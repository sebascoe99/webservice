...
class ServicioImagenesController extends Controller
{
    public function llamarVistaWordpress()
    {
        return view('wordpress');
    }


    public function llamarVistaMagento()
    {
        return view('magento');
    }

    public function llamarVistaCkeditor()
    {
        return view('ckeditor');
    }

    public function llamarVistaMarca()
    {
        return view('marca');
    }

    public function implementarFormularioWordpress(Request $request)
    {
                $consulta = new db();
